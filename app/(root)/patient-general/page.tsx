...
const PatientInfo = () => {
  ...
  const handleSaveAndNavigate = () => {
    ...
    localStorage.setItem("otherStates", otherStates);

    // Navigate to the new page
    router.push("/patient-medical");
  };
            ...
            <div className="flex flex-col justify-center gap-3 mt-4 p-6">
              ...
              <div className="button-group flex gap-2 mb-4">
                <button
                  ...
                  className={`h-12 focus:outline-none p-3 md:p-4  ${sex === "Male" ? "bg-gray-800 text-white" : "border-2 border-gray-300 focus:ring-blue-300 focus:border-blue-300 text-black"
                    }`}
                >
                  Male
                </button>
                <button
                  ...
                  className={`h-12 focus:outline-none p-3 md:p-4  ${sex === "Female" ? "bg-gray-800 text-white" : "border-2 border-gray-300 focus:ring-blue-300 focus:border-blue-300 text-black"
                    }`}
                >
                  Female
                </button>
              ...
              <div className="flex flex-col gap-2">
                <select
                  className={`border-2 border-gray-300 focus:ring-blue-300 focus:border-blue-300 h-12 focus:outline-none p-2 md:p-2 rounded-lg text-sm mb-4 ${!stage ? "text-gray-500" : "text-black"
                    }`}
                  value={state}
                ...
                {(state == "Other") && (
                  <>
                    ...
                    <input
                      type="text"
                      className="border-2 border-gray-300 focus:ring-blue-300 focus:border-blue-300 text-black h-12 focus:outline-none p-3 md:p-4 mb-5 rounded-lg text-sm mx-8"
